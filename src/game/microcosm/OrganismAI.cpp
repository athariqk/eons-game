...
void OrganismAI::checkForNutrients() {
    // TODO: Implement nutrient checking using entity manager through scene
    // This would require exposing GetGroup through the scene interface
    // auto *scene = entity->GetManager().GetScene();
    // if (auto *microcosmScene = dynamic_cast<MicrocosmScene*>(scene)) {
    //     // Access entity groups through microcosm scene
    // }
}
