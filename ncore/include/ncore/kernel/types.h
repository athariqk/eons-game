...
struct TypeInfo {
     ...
     */
    virtual bool is_record() const noexcept { return false; }
};
 ...
 */
struct RecordInfo : public TypeInfo {
    ...
    bool is_record() const noexcept override { return true; }
    ...
    virtual void visit(void const *instance, RecordVisitor *visitor,
                       PropertyFlags filter = static_cast<PropertyFlags>(0xFFFF), unsigned depth = 0) const noexcept;

    virtual void visit_field(void const *ptr, const FieldInfo *field, RecordVisitor *visitor, PropertyFlags filter,
                             int depth, int array_elem = -1) const noexcept;

    virtual void visit_array(void const *ptr, const FieldInfo *field, RecordVisitor *visitor, PropertyFlags filter,
...
struct VectorClass : public RecordInfo {
    ...
    void visit(void const *instance, RecordVisitor *visitor, PropertyFlags filter,
