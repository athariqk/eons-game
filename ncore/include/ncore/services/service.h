...
/**
 * @brief IService is an abstraction of raw engine power as a set of
 ...
 *
 * When creating a new IService, the line of thinking usually goes like:
 * if I can leverage one or more IServices to achieve what I need, then
 * I probably should just use them. If one or more IServices can't provide
...
class NCAPI NullService : public IService {
