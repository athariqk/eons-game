...
bool ImGui_ImplSDLRenderer3_CreateFontsTexture() {
    ...
    io.Fonts->GetTexDataAsRGBA32(
        &pixels, &width, &height); // Load read RGBA 32-bit (75% of the memory is wasted, but default font is so small)
...
bool ImGui_ImplSDLRenderer3_CreateDeviceObjects() { return ImGui_ImplSDLRenderer3_CreateFontsTexture(); }

void ImGui_ImplSDLRenderer3_DestroyDeviceObjects() { ImGui_ImplSDLRenderer3_DestroyFontsTexture(); }
