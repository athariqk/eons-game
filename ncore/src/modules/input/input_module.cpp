...
void InputModule::action_register( const String& name )
{
...
void InputModule::action_bind_event( const char* name, const InputEvent& event )
{
...
bool InputModule::action_exists( const char* name )
{
    return action_by_name.contains( name );
}

bool InputModule::action_is_held( const char* name )
{
    return get_action_( name )->state.held;
}

bool InputModule::action_is_pressed( const char* name )
{
    return get_action_( name )->state.pressed;
}

bool InputModule::action_is_released( const char* name )
{
    return get_action_( name )->state.released;
}

float InputModule::action_get_axis( const char* neg_action, const char* pos_action )
{
...
Vec2 InputModule::action_get_vector(
...
bool InputModule::is_anything_held() const
{
    return is_any_held;
}

bool InputModule::is_anything_pressed() const
{
    return is_any_pressed;
}

Vec2 InputModule::get_mouse_position() const
{
    return mouse_pos;
}

Vec2 InputModule::get_mouse_delta() const
{
    return mouse_delta;
}

Vec2 InputModule::get_mouse_wheel() const
{
    return mouse_wheel;
}

bool InputModule::is_mouse_button_pressed( ButtonIndex button ) const
{
    return mb_states[static_cast<size_t>( button )].pressed;
}

void InputModule::action_list( DynamicArray<StringView>& out )
{
...
void InputModule::add_input_event( const InputEvent& event )
{
...
InputModule::ActionBinding* InputModule::get_action_( const char* name )
{
